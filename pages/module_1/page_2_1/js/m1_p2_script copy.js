...
function addSectionData() {
  ...
  "<div class='top-alignText'>" +
    "<div class='instruction instruction_1' id='instruction_1'></div>" +
    "<div class='instruction instruction_2' id='instruction_2'></div>" +
    "<div class='instruction instruction_3' id='instruction_3'></div>" +
  "</div>" +   
      ...
      container_popup .append(`<div class="ins_1_popup">
            ...
            <div class="overlay-layer">
                <div class="text-pos">
                    ...
                    // <div class="heder-text">${popup.header}</div>
                    // <div class="game-rule-1">${popup.text_1}</div>
                    // <div class="game-rule-2">${popup.text_2}</div>                                
        ...
        container_popup .append(`<div class="ins_2_popup">
            ...
            <div class="overlay-layer">
                ...
                <div class="heder-text">${popup2.header}</div>
                <div class="game-rule-1">${popup2.text_1}</div>                             
        ...
        container_popup .append(`<div class="ins_3_popup">
            ...
            <div class="overlay-layer">
                ...
                <div class="heder-text">${popup3.header}</div>
                <div class="game-rule-1">${popup3.text_1}</div>    
                <div class="game-rule-1">${popup3.text_2}</div>                             
                <div class="close_ins_3_popup">${popup3.close}</div>
            </div>
        </div>`);

            $('.instruction').off('click').on('click', onClickHandler)
